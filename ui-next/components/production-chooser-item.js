...
var
  ...
  tmplItem = /* @__PURE__ */ template(`<div class="flex flex-row flex-auto items-center"><div class="relative flex flex-col flex-auto justify-center ml-1 my-1"><div class="flex flex-row flex-wrap items-center"><div class="shrink font-title-sm text-accent-2 uppercase tracking-25 z-1 mr-3"></div><div class="flex items-center"></div></div></div><div class="flex flex-row items-center justify-end"><div class="flex flex-col flex-auto items-end leading-normal relative"></div></div></div>`);
