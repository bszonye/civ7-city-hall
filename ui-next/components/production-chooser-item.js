...
var
  ...
  _tmpl$2 = /* @__PURE__ */ template(`<div class="bz-pci-details flex items-center text-xs -ml-1 -mb-0\\.5 leading-normal"></div>`),
  ...
  _tmpl$5 = /* @__PURE__ */ template(`<div class="bz-pci-yields flex items-center text-xs -mb-0\\.5 leading-normal"></div>`),
  ...
  _tmpl$6 = /* @__PURE__ */ template(`<div class="bz-pci-cost flex flex-row items-center self-end mr-0\\.5"><span class="text-sm"></span><span class="bz-pci-icon size-8 -my-1 bg-contain bg-center bg-no-repeat"></span></div>`),
  ...
  _tmpl$7 = /* @__PURE__ */ template(`<div class="flex flex-row flex-auto items-center"><div class="relative flex flex-col flex-auto justify-center ml-1 my-1"><div class="flex flex-row flex-wrap items-center"><div class="shrink font-title text-accent-2 uppercase tracking-25 z-1 mr-3"></div><div class="flex items-center"></div></div><div class="flex flex-row"></div></div><div class="flex flex-row items-center justify-end"><div class="flex flex-col flex-auto items-end leading-normal relative"></div></div></div>`);
      ...
      return createComponent(AudioContextProvider, {
        ...
        get children() {
          return createComponent(ChooserItem, {
            ...
            get children() {
              var _el$ = _tmpl$7(), _el$2 = _el$.firstChild, elTitle = _el$2.firstChild, _el$3 = elTitle.firstChild, _el$14 = elTitle.nextSibling, _el$15 = _el$2.nextSibling, _el$16 = _el$3.nextSibling, _el$17 = _el$15.firstChild;
              ...
              insert(_el$16, createComponent(Show, {
                ...
                get children() {
                  ...
                  const pill = createComponent(PillText, {
                    "class": "bz-pci-ageless py-px -my-px -ml-1 mr-3",
                    text: "LOC_UI_PRODUCTION_AGELESS"
                  });
                  pill.classList.replace("text-sm", "text-xs");
                  pill.classList.replace("leading-normal", "leading-tight");
                  pill.classList.remove("min-h-9");
                  return pill;
                }
              }), null);
              insert(_el$16, createComponent(Show, {
                ...
                get children() {
                  var elRecs = tmplRecs();
                  insert(elRecs, createComponent(AdvisorRecommendationsList, {
                    get recommendations() {
                      return recommendations();
                    },
              ...
              insert(_el$17, createComponent(Show, {
                ...
                get children() {
                  ...
                  createRenderEffect((_p$) => {
                    ...
                    _el$20.classList.toggle("invisible", isInProgress());
                    return _p$;
                  }, {
                    e: void 0,
                    t: void 0
